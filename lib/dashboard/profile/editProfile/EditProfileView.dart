...
class EditProfileView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    profileController.addAccountItems(
        ...
        false,
        homeController.profileData.value.gender.toString(),
        false);
    profileController.emailController.value = homeController.profileData.value.email!;
    profileController.userName.value = homeController.profileData.value.name!;
    profileController.phoneController.value = homeController.profileData.value.mobileNumber!;
          ...
          children: [
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: TextFormField(
                          ...
                          controller: TextEditingController()
                            ..text = homeController.profileData.value.name!,
                          onChanged: (text) => {profileController.userName.value = text},
                    ...
                    Container(
                      ...
                      child: TextFormField(
                          ...
                          controller: TextEditingController()
                            ..text = homeController.profileData.value.email!,
                          onChanged: (text) =>
                    ...
                    Container(
                      ...
                      child: TextFormField(
                          ...
                          onChanged: (text) => {profileController.phoneController.value = text},
                          ...
                          child: Container(
                            ...
                            child: Center(
                              child: DropdownButtonFormField<String>(
                                ...
                                hint:
                                    Text(Utils.getString(context, 'gender_hint'),
                                        style: CommonUi.customTextStyle1(
                                          Fonts.interRegular,
                                          12.0,
                                          FontWeight.w400,
                                ...
                                onChanged: (String? newValue) {
                                  CommonUi.hideKeyBoard(context);
                                  profileController.genderValue.value = newValue!;
                                },
                                items: <String>[
                                  'Male',
                                  'Female',
            ...
            Container(
              ...
              child: Text(
                ...
                style: CommonUi.customTextStyle1(
                    Fonts.interRegular, 14.0, FontWeight.w400, AppColors.redEdit, TextDecoration.none),
              ),
            )
          ],
        ),
