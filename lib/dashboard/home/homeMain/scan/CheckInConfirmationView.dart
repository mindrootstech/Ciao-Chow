...
class CheckInConfirmationView extends StatelessWidget {

  DashBoardController dashboardController = Get.find();
  var businessName;
  CheckInConfirmationView(this.businessName);
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                      'Your ' + businessName + ' check-in is successfully done. You are very close to earn a badge keep going.',
                        style: CommonUi.customTextStyle1(
                            Fonts.interMedium,
                            14.0,
                            FontWeight.w500,
