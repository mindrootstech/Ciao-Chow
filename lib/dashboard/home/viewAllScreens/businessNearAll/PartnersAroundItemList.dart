...
class PartnersAroundItemList extends StatelessWidget {
  ...
  PartnersAroundItemList(this.index, this.partnersAllNearController, {Key? key})
      : super(key: key);
    ...
    return GestureDetector(
      onTap: () {
        Get.to(BusinessDetailsView(
            partnersAllNearController.arrayBusinessList[index].id.toString()));
      },
                    ...
                    child: Column(
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: Text(
                            partnersAllNearController
                                .arrayBusinessList[index].businessName!,
                        ...
                        Container(
                          ...
                          child: Text(
                            partnersAllNearController
                                .arrayBusinessList[index].address!,
                            style: CommonUi.customTextStyle1(
                                Fonts.interRegular,
                                12.0,
                                FontWeight.w400,
                        ...
                        partnersAllNearController
                                    .arrayBusinessList[index].distance
                                    .toString() !=
                                ''
                            ? Container(
