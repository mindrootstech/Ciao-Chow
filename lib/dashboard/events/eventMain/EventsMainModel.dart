...
EventsMainModel eventsMainModelFromJson(String str) => EventsMainModel.fromJson(json.decode(str));

String eventsMainModelToJson(EventsMainModel data) => json.encode(data.toJson());
...
class EventsMainModel {
  ...
  factory EventsMainModel.fromJson(Map<String, dynamic> json) => EventsMainModel(
    status: json["status"],
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
    ...
    myEventsTickets: List<MyEventsTicket>.from(json["my_events_tickets"].map((x) => MyEventsTicket.fromJson(x))),
    upcomingEvents: List<Event>.from(json["upcoming_events"].map((x) => Event.fromJson(x))),
  );

  Map<String, dynamic> toJson() => {
    "banners": List<dynamic>.from(banners!.map((x) => x.toJson())),
    "my_events_tickets": List<dynamic>.from(myEventsTickets!.map((x) => x.toJson())),
